...
with col:
    st.image('https://img1.baidu.com/it/u=1085352644,3200471532&fm=253&fmt=auto&app=138&f=JPEG?w=890&h=500',width=300)
    flag = st.button("施施",use_container_width=True)
    if flag:
        st.switch_page("pages/demo3.py")

with col1:
    st.image('https://img1.baidu.com/it/u=4220817563,2685080531&fm=253&fmt=auto&app=120&f=JPEG?w=1024&h=683', width=260)
